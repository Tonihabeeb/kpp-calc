"""
Drivetrain configuration for the KPP simulator.
Defines parameters for the integrated drivetrain system.
"""
...
class DrivetrainConfig:
    """Configuration for the integrated drivetrain system."""
    ...
    # Flywheel parameters
    flywheel_inertia: float = field(default=500.0, metadata={"description": "Flywheel moment of inertia", "unit": "kg·m²"})
    flywheel_max_speed: float = field(default=400.0, metadata={"description": "Maximum flywheel speed", "unit": "rad/s"})
    flywheel_mass: float = field(default=1000.0, metadata={"description": "Flywheel mass", "unit": "kg"})
    
    # Target speeds
    target_generator_speed: float = field(default=375.0, metadata={"description": "Target generator speed", "unit": "RPM"})
    
    # Clutch parameters
    clutch_engagement_threshold: float = field(default=0.1, metadata={"description": "Clutch engagement threshold", "unit": "rad/s"})
    clutch_disengagement_threshold: float = field(default=-0.05, metadata={"description": "Clutch disengagement threshold", "unit": "rad/s"})
