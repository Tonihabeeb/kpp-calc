...
class MarketInterface:
    ...
    def calculate_settlement(self, period_start: datetime, period_end: datetime) -> Optional[SettlementData]:
        ...
        try:
            ...
            relevant_bids = [
                ...
                if (bid.status == BidStatus.CLEARED and
                    bid.start_time <= period_end and
                    bid.end_time >= period_start)
            ]
            ...
            # Calculate revenues
            energy_revenue = sum(
                bid.cleared_capacity * bid.cleared_price * 
    ...
    def get_market_prices(self, market_type: MarketType, lookback_hours: int = 24) -> List[float]:
        ...
        recent_clearings = [
            ...
            if c.clearing_time >= cutoff_time
        ]
    ...
    def get_active_commitments(self) -> List[MarketBid]:
        ...
        return [
            ...
            if (bid.status == BidStatus.CLEARED and
                bid.start_time <= now <= bid.end_time)
        ]
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_settlement': (
                ...
                if self.settlement_history else None
            )
        }
    ...
    def _validate_bid_data(self, bid_data: Dict[str, Any]):
        ...
        required_fields = [
            'market_type', 'service_type', 'capacity_mw', 
            'price_mwh', 'duration_hours', 'start_time', 'end_time'
        ]
    ...
    def _update_bid_status(self, clearing: MarketClearing):
        ...
        for bid in list(self.active_bids.values()):
            if (bid.market_type == clearing.market_type and
                bid.status == BidStatus.SUBMITTED):
