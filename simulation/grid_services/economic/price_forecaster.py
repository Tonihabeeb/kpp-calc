...
class PriceForecaster:
    ...
    def _initialize_patterns(self):
        ...
        self.daily_patterns = {
            'weekday': self._create_daily_pattern([
                0.8, 0.7, 0.7, 0.7, 0.8, 0.9,  # 00-05: Night
                1.1, 1.3, 1.5, 1.4, 1.2, 1.1,  # 06-11: Morning
                1.2, 1.3, 1.4, 1.5, 1.8, 1.9,  # 12-17: Afternoon/Peak
                1.7, 1.4, 1.2, 1.1, 1.0, 0.9   # 18-23: Evening
            ]),
            'weekend': self._create_daily_pattern([
                0.7, 0.6, 0.6, 0.6, 0.7, 0.8,  # 00-05: Night
                0.9, 1.0, 1.1, 1.2, 1.3, 1.3,  # 06-11: Morning
                1.4, 1.4, 1.5, 1.4, 1.3, 1.3,  # 12-17: Afternoon
                1.2, 1.1, 1.0, 0.9, 0.8, 0.7   # 18-23: Evening
            ])
        }
    ...
    def get_price_statistics(self, hours_back: int = 168) -> Dict[str, float]:
        ...
        recent_prices = [
            price for _, price in list(self.price_history)[-hours_back:]
        ]
