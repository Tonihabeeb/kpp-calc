...
class BiddingStrategyController:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        self.market_weights = config.get('market_weights', {
            'energy_rt': 0.4,
            'energy_da': 0.3,
            'freq_reg': 0.2,
            'spinning_res': 0.1
    ...
    def generate_bid_recommendations(self, 
                                   market_conditions: MarketConditions,
                                   operational_constraints: OperationalConstraints,
                                   forecast_horizon: int = 24) -> List[BidRecommendation]:
        """
    ...
    def calculate_bid_price(self, 
                          ...
                          base_cost: float,
                          market_conditions: MarketConditions,
                          strategy: Optional[BiddingStrategy] = None) -> float:
        """
        ...
        try:
            ...
            risk_premium = self._calculate_risk_premium(
                service_type, market_conditions
            )
    ...
    def assess_portfolio_risk(self) -> Dict[str, float]:
        ...
        try:
            ...
            # Overall risk score
            overall_risk = np.sqrt(
                concentration_risk**2 + market_risk**2 + 
                operational_risk**2 + liquidity_risk**2
            ) / 2.0
    ...
    def _calculate_optimal_bid(self, opportunity: Dict[str, Any], 
                             conditions: MarketConditions,
                             constraints: OperationalConstraints) -> Optional[Dict[str, Any]]:
