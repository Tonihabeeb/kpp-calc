...
class PowerFactorController:
    ...
    def update(self, active_power_pu: float, reactive_power_pu: float, dt: float, 
               rated_power: float, voltage_regulation_active: bool = False) -> Dict[str, Any]:
        """
    ...
    def get_performance_metrics(self) -> Dict[str, float]:
        ...
        avg_control_time = (self.total_control_time / self.control_count 
                          if self.control_count > 0 else 0.0)
