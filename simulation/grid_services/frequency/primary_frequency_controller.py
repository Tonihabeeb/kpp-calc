...
class PrimaryFrequencyController:
    ...
    def update(self, grid_frequency: float, dt: float, rated_power: float) -> Dict[str, Any]:
        ...
        self.frequency_history = [
            entry for entry in self.frequency_history 
        ...
        if abs(frequency_error) <= self.config.dead_band:
            ...
            self.target_response = max(-self.config.response_range, 
        ...
        self.max_response_magnitude = max(self.max_response_magnitude, 
                                        abs(self.current_response))
    ...
    def get_performance_metrics(self) -> Dict[str, float]:
        ...
        avg_response_time = (self.total_response_time / self.response_count 
