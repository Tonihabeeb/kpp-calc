...
class OneWayClutch:
    ...
    def __init__(self, engagement_threshold: float = 0.1, disengagement_threshold: float = -0.05, 
                 max_torque: float = 10000.0, engagement_time: float = 0.05):
        """
    ...
    def update(self, input_speed: float, output_speed: float, input_torque: float, dt: float) -> float:
        ...
        logger.debug(f"Clutch: engaged={self.is_engaged}, factor={self.engagement_factor:.3f}, "
