...
class PneumaticSystem:
    ...
    def vent_air(
        self,
        vent_duration: Optional[float] = None,
        ...
        if vent_duration is None or target_pressure is None:
            return {
                "volume_vented": 0.0,
                "final_pressure": self.tank_pressure * 100000.0,
            }
    ...
    def calculate_thermal_buoyancy_boost(
        self,
        air_volume: float,
    ...
    def update(self, dt: float) -> None:
        ...
        if self.compressor_on:
            ...
            logger.debug(
                f"Compressor running: pressure={self.tank_pressure:.2f} bar, energy_used={self.energy_used:.2f} kJ"
            )
    ...
    def analyze_thermodynamic_cycle(
        self,
