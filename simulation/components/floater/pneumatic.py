...
class PneumaticSystem:
    ...
    def start_injection(self, target_volume: float, injection_pressure: float, current_time: float) -> bool:
    ...
    def update_injection(self, injected_volume: float, dt: float) -> None:
        ...
        self.state.air_fill_level = min(1.0, self.state.total_air_injected / self.state.target_air_volume)
    ...
    def update_venting(self, venting_rate: float, dt: float) -> bool:
        ...
        self.state.air_fill_level = max(0.0, self.state.air_fill_level - air_volume_lost)
