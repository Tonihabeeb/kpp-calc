...
class Control:
    ...
    """
    def __init__(self, simulation=None, floaters=None, pneumatic=None, sensors=None, top_sensor=None, bottom_sensor=None, drivetrain=None, target_rpm=20.0, Kp=1.0, Ki=0.0, Kd=0.0, use_clutch=False, T_eng=2.0, T_free=2.0):
        """
    ...
    def update(self, dt: float) -> None:
        ...
        for floater in self.floaters:
            ...
            # FILLING: Wait for fill duration or pressure, then stop
                ...
                if (t_now - (floater.fill_start_time or 0)) >= fill_duration or floater.internal_pressure >= target_pressure:
