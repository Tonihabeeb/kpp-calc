...
class DataStreamManager:
    ...
    def configure_streaming(self, enabled: bool = True, sample_rate: float = 10.0,
...
class RealTimeMonitor:
    ...
    def add_monitor(self, monitor_id: str, data_path: str, 
                   threshold: float, condition: str = 'greater',
    ...
    def _trigger_alert(self, monitor_id: str, monitor: Dict[str, Any], 
        ...
        if error_type in self.recovery_strategies:
            try:
                ...
                if recovery_result.get('success', False):
                    ...
                    logger.warning(f"Recovery failed for {error_type}: {recovery_result.get('message', 'Unknown reason')}")
...
class RealTimeController:
    ...
    def _setup_default_monitors(self):
        ...
        self.monitor.add_monitor('high_computation_time', 'metadata.computation_time', 0.2, 'greater', 'warning')
    ...
    def process_realtime_data(self, simulation_data: Dict[str, Any], 
