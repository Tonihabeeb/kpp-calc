...
class PerformanceMonitor:
    ...
    def __init__(
        ...
        self.current_metrics = PerformanceMetrics(
            timestamp=time.time(), step_duration=0.0, memory_usage_mb=0.0, cpu_usage_percent=0.0
        )
        ...
        if metrics.step_duration > self.alert_thresholds["step_duration_error"]:
            alerts.append(
                PerformanceAlert(
                    ...
                    details={
                        "step_duration": metrics.step_duration,
                        "threshold": self.alert_thresholds["step_duration_error"],
                    },
                )
            )
            ...
            alerts.append(
                PerformanceAlert(
                    ...
                    details={
                        "step_duration": metrics.step_duration,
                        "threshold": self.alert_thresholds["step_duration_warning"],
                    },
                )
            )
            ...
            alerts.append(
                PerformanceAlert(
                    ...
                    details={
                        ...
                        "threshold": self.alert_thresholds["memory_usage_error"],
                    },
                )
            )
            ...
            alerts.append(
                PerformanceAlert(
                    ...
                    details={
                        ...
                        "threshold": self.alert_thresholds["cpu_usage_error"],
                    },
                )
            )
