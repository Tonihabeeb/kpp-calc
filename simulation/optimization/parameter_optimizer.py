...
class ParameterOptimizer:
    ...
    def add_parameter(self, name: str, current_value: float, min_value: float, 
                     max_value: float, step_size: float, description: str = ""):
    ...
    def _apply_parameters(self, simulation_engine, params: Dict[str, float]):
        ...
        if hasattr(simulation_engine, 'advanced_event_handler'):
            if 'injection_pressure_factor' in params:
                simulation_engine.advanced_event_handler.optimization_params['pressure_safety_factor'] = params['injection_pressure_factor']
    ...
    def get_optimization_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'convergence_achieved': self.optimization_history[-1].get('convergence', False) if self.optimization_history else False
        }
