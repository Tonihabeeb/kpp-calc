...
class PerformanceAnalyzer:
    ...
    def __init__(
        ...
        logger.info(
            "PerformanceAnalyzer initialized: rated_power=%.1fW, baseline_eff=%.3f",
            rated_power,
            baseline_efficiency,
        )
    ...
    def record_performance_snapshot(
        ...
        logger.debug(
            "Performance snapshot recorded: power=%.1fW, efficiency=%.3f",
            electrical_power,
    ...
    def calculate_eroi_analysis(self, time_window: float = 3600.0) -> EROIAnalysis:
        ...
        logger.info(
            "EROI analysis: ratio=%.2f, payback=%.1fs, net_gain=%.2fkJ",
            eroi_ratio,
            payback_time,
            net_energy_gain / 1000,
        )
    ...
    def calculate_capacity_analysis(self, time_window: float = 3600.0) -> CapacityAnalysis:
        ...
        logger.info(
            "Capacity analysis: factor=%.3f, utilization=%.3f, efficiency=%.3f",
            capacity_factor,
            utilization_factor,
...
def create_standard_performance_analyzer(
