...
class KPPPhysicsCalculator:
    ...
    def calculate_pneumatic_force_contribution(
        self,
    ...
    def calculate_thermodynamic_properties(
        self, pressure: float, temperature: float, volume: float
    ) -> Dict[str, float]:
        """
    ...
    def calculate_gas_expansion_work(
        self,
