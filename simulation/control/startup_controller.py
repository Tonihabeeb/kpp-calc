...
class StartupController:
    ...
    def _process_initialization_phase(self, system_state: Dict, current_time: float) -> Dict:
        ...
        commands = {
            ...
            "pneumatic_commands": {"compressor_enabled": True, "tank_isolation": False},
            "electrical_commands": {"generator_enable": False, "grid_connect": False},
            "control_commands": {"timing_mode": "manual", "load_limit": 0.0},
        }
    ...
    def _process_acceleration_phase(self, system_state: Dict, current_time: float) -> Dict:
        ...
        if "flywheel_acceleration" in system_state:
            self.metrics.max_acceleration = max(
                self.metrics.max_acceleration,
    ...
    def _process_operational_phase(self, system_state: Dict, current_time: float) -> Dict:
        ...
        return {
            ...
            "electrical_commands": {"generator_enable": True, "grid_connect": True},
            "control_commands": {
                "timing_mode": "normal",
    ...
    def _perform_system_checks(self, system_state: Dict) -> Dict:
        ...
        if floater_count < self.conditions.min_floater_count:
            ...
            self.fault_conditions.append(
                f"Insufficient floaters for startup ({floater_count} < {self.conditions.min_floater_count})"
            )
