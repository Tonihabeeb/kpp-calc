...
class TransientEventController:
    ...
    def _coordinate_transient_commands(self, emergency_cmds: Dict, grid_cmds: Dict, 
                                     startup_cmds: Dict, current_time: float) -> Dict:
        ...
        if startup_cmds.get('startup_active', False):
            ...
            if self.grid_support_enabled and grid_cmds.get('grid_disturbance_active', False):
                ...
                if grid_cmds.get('response_mode') in ['ride_through', 'frequency_support']:
    ...
    def _update_metrics(self, current_time: float):
        ...
        if startup_status.get('startup_complete', False):
            ...
            if startup_time > 0:
                ...
                self.metrics['average_startup_time'] = (avg_startup * (total_startups - 1) + startup_time) / total_startups
