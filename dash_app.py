    ...
    async def connect_to_master_clock(self):
        ...
        try:
            self.connection = await websockets.connect(
                f"{self.master_clock_url}?type=frontend",
                ping_interval=10,
                ping_timeout=5
            )
            self.connected = True
...
def create_advanced_parameters_panel():
    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=5, max=30, step=1, value=16,  # Updated to new default
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.01, max=0.2, step=0.01, value=0.1,  # Updated to new default
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.1, max=2.0, step=0.1, value=1.2,  # Updated to new default
                        marks={i/10: f"{i/10}" for i in range(1, 21, 5)},
                        tooltip={"placement": "bottom", "always_visible": True}
                    ),
                ...
                dbc.Col([
                    html.Label([
                        ...
                        html.I("?", id="pressure-recovery-help", style={"cursor": "pointer", "color": "#888"})
                    ]),
                    dcc.Slider(
                        id="pressure-recovery-slider",
                        min=0.1, max=0.4, step=0.02, value=0.22,  # New parameter
                    ...
                    dbc.Tooltip(
                        ...
                        target="pressure-recovery-help", placement="top"
                    )
                ], width=4)
            ], className="mb-3"),
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.5, max=2.0, step=0.1, value=1.2,  # Updated to new default
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=50, max=600, step=50, value=500,  # Updated to new default
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=50, max=200, step=10, value=120,  # New parameter
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=40, max=150, step=10, value=90,  # New parameter
            ...
            dbc.Button("Submit Advanced Parameters", id="submit-advanced-params-btn", color="primary", className="mt-3", n_clicks=0)
        ])
    ], className="mb-4")
...
def create_physics_controls_panel():
    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.0, max=0.1, step=0.01, value=0.05,  # Updated default
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.0, max=0.25, step=0.01, value=0.12,  # New parameter
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.5, max=1.0, step=0.05, value=0.8,  # Updated parameter
                        marks={i/100: f"{i/100:.2f}" for i in range(50, 101, 10)},
                        tooltip={"placement": "bottom", "always_visible": True}
                    ),
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.0, max=0.15, step=0.01, value=0.06,  # New parameter
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.5, max=3.0, step=0.1, value=2.0,  # New parameter
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.2, max=2.0, step=0.1, value=1.0,  # New parameter
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=5, max=50, step=1, value=20,  # Updated to Celsius
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=5, max=50, step=1, value=20,  # New parameter
                        marks={i: f"{i}°C" for i in range(5, 51, 10)},
                        tooltip={"placement": "bottom", "always_visible": True}
                    ),
            ...
            # Submit button
            dbc.Button("Submit Physics Controls", id="submit-physics-controls-btn", color="success", className="mt-3", n_clicks=0)
        ])
    ], className="mb-4")
...
def create_system_overview_panel():
    ...
    return dbc.Card([
        ...
        dbc.CardBody([
            dbc.Row([
                dbc.Col([
                    html.H6("Drivetrain Status", className="text-primary"),
                    html.Div(id="drivetrain-overview", children="Initializing...")
                ], width=6),
                dbc.Col([
    ...
    return dbc.Navbar(
        dbc.Container([
            dbc.Row([
                dbc.Col([
                    html.Div([
                        html.I(className="fas fa-bolt", style={"fontSize": "2rem", "marginRight": "0.75rem", "color": "#60a5fa"}),
                        dbc.NavbarBrand("KPP Simulator Dashboard", className="text-gradient", style={"fontSize": "1.75rem", "fontWeight": "700"})
                ...
                dbc.Col([
                    dbc.ButtonGroup([
                        dbc.Button([
                            ...
                            "Start"
                        ], id="start-btn", color="success", size="lg", className="px-4"),
                        dbc.Button([
                            html.I(className="fas fa-pause me-2"),
                            "Pause"
                        ], id="pause-btn", color="warning", size="lg", className="px-4"),
                        dbc.Button([
                            html.I(className="fas fa-stop me-2"),
                            "Stop"
                        ], id="stop-btn", color="danger", size="lg", className="px-4"),
                        dbc.Button([
...
def create_metrics_cards():
    ...
    return dbc.Row([
        dbc.Col([
            html.Div([
                html.Div([
                    html.I(className="fas fa-bolt", style={"fontSize": "1.5rem", "color": "#2563eb", "marginBottom": "0.5rem"}),
        ...
        dbc.Col([
            html.Div([
                html.Div([
                    html.I(className="fas fa-cog", style={"fontSize": "1.5rem", "color": "#059669", "marginBottom": "0.5rem"}),
        ...
        dbc.Col([
            html.Div([
                html.Div([
                    html.I(className="fas fa-tachometer-alt", style={"fontSize": "1.5rem", "color": "#f59e0b", "marginBottom": "0.5rem"}),
        ...
        dbc.Col([
            html.Div([
                html.Div([
                    html.I(className="fas fa-clock", style={"fontSize": "1.5rem", "color": "#3b82f6", "marginBottom": "0.5rem"}),
            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    dcc.Graph(
                        ...
                        figure={
                            "data": [
                                {"x": [], "y": [], "type": "scatter", "mode": "lines", "name": "Power (W)", "line": {"color": "#2563eb", "width": 3}},
                                {"x": [], "y": [], "type": "scatter", "mode": "lines", "name": "Torque (Nm)", "line": {"color": "#059669", "width": 3}, "yaxis": "y2"}
                            ],
                            "layout": {
                                "title": {"text": "Power & Torque vs Time", "font": {"size": 18, "family": "Inter"}},
                                "xaxis": {"title": "Time (s)", "gridcolor": "#e5e7eb"},
                                "yaxis": {"title": "Power (W)", "side": "left", "gridcolor": "#e5e7eb"},
                                "yaxis2": {"title": "Torque (Nm)", "side": "right", "overlaying": "y", "gridcolor": "#e5e7eb"},
            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    dcc.Graph(
                        ...
                        figure={
                            "data": [
                                {"x": [], "y": [], "type": "scatter", "mode": "lines", "name": "Overall Efficiency", "line": {"color": "#f59e0b", "width": 3}, "fill": "tonexty"}
                            ],
                            "layout": {
                                "title": {"text": "System Efficiency vs Time", "font": {"size": 18, "family": "Inter"}},
                                "xaxis": {"title": "Time (s)", "gridcolor": "#e5e7eb"},
                                "yaxis": {"title": "Efficiency (%)", "range": [0, 100], "gridcolor": "#e5e7eb"},
                                "height": 400,
                                "plot_bgcolor": "rgba(0,0,0,0)",
                                "paper_bgcolor": "rgba(0,0,0,0)",
                                "font": {"family": "Inter"}
            ...
            dbc.Row([
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=100000, max=500000, step=50000, value=400000,
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=0.5, max=5.0, step=0.5, value=2.2,
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Slider(
                        ...
                        min=75, max=600, step=25, value=530,
...
def update_chart_data(new_data, current_chart_data):
    ...
    if current_time > 0:
        ...
        if not current_chart_data["time"] or current_time > current_chart_data["time"][-1]:
            ...
            current_chart_data["efficiency"].append(new_data.get("overall_efficiency", 0) * 100)  # Convert to percentage
...
def unified_param_notification_preset_callback(
    n_intervals, preset_value, adv_n_clicks, physics_n_clicks, save_preset, delete_preset,
    presets, current_params, floater_mass, floater_area, air_fill_time, air_flow_rate, jet_efficiency, sprocket_radius, flywheel_inertia,
    h1_enabled, nano_frac, h2_enabled, thermal_efficiency, water_temp, ambient_temp
):
    import dash, requests, json, logging
    ctx = dash.callback_context
    notification = {"show": False, "message": "", "color": "info"}
    params = dash.no_update
    last_params = dash.no_update
    presets_out = dash.no_update
        ...
        if adv_n_clicks:
            try:
                ...
                if response.status_code == 200:
                    ...
                    notification = {"show": True, "message": f"Failed to update parameters: {response.text}", "color": "danger"}
            except Exception as e:
        ...
        if physics_n_clicks:
            try:
                ...
                if response.status_code == 200:
                    ...
                    notification = {"show": True, "message": f"Failed to update physics controls: {response.text}", "color": "danger"}
            except Exception as e:
...
@app.callback(
    ...
    [Input("start-btn", "n_clicks"),
     ...
     Input("simulation-data-store", "data")],  # Add simulation data as input
...
def handle_action_outputs(step_clicks, pulse_clicks, load_clicks, emergency_clicks, h1_clicks, mode_clicks,
                         input_clicks, output_clicks, energy_clicks, performance_clicks, fluid_clicks, thermal_clicks,
                         load_value, control_mode, sim_data):
    import requests
    ...
    try:
        if button_id == "btn-step":
            ...
            if control_mode:
                ...
                return "", "", "", "", "", f"Control mode set to {control_mode}: {response.json()}", "", "", "", "", "", ""
...
def validate_advanced_parameters(floater_mass, floater_area, air_fill_time, air_flow_rate, jet_efficiency, sprocket_radius, flywheel_inertia):
    errors = ["", "", "", "", "", "", ""]
            ...
            if ws_data.get('status') == 'success':
                ...
                if kpp_data:
                    ...
                    fallback_data = {
                        ...
                        'status': kpp_data.get('status', 'success'),  # Use 'success' if WebSocket response is successful
