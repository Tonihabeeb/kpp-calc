...
def quick_test():
    ...
    try:
        ...
        electrical = electrical_response.json() if electrical_response.status_code == 200 else {}
        ...
        if power > 0:
            ...
            print(f"   STATUS: ⚠ PARTIAL - Generator working ({gen_power:.0f}W) but main output is 0")
        else:
